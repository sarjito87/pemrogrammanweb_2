    ...
    <div class="row mt-5">
        <div class="col-12">
            ...
            <div class="row">
                <div class="col-4">
                    <div class="card">
                        <img src="https://down-id.img.susercontent.com/file/2289f8103aa4f04e9689ad0403b03f24" class="card-img-top" alt="...">
                        <div class="card-body">
                ...
                <div class="col-4">
                    <div class="card">
                        <img src="https://images.tokopedia.net/img/cache/500-square/hDjmkQ/2023/6/30/bc53c848-b39e-4f91-8498-ea2c950a1f75.jpg" class="card-img-top" alt="...">
                        <div class="card-body">
